...
class Mapp extends React.Component {
    ...
    componentDidMount() {
        ...
        // // el.style.background = "url('/img/hospitals/maphospital.png')";
        ...
        data.forEach((location) => {
            var marker = new mapboxgl.Marker({
                ...
                .setPopup(new mapboxgl.Popup({ offset: 25 })
                    // .setHTML("<div id='popu'> <img src="+ location.image + "/><div><h4 id='teste' >" + location.location + "</h4>" + location.city + "<br>" + location.state + "</div></div>" ))
                    .setHTML(
                        "<div id='popup'><a href='#'>" + 
